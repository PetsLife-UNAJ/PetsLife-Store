...
namespace AccessData.Configuration
{
    public class ProductoConfiguration : IEntityTypeConfiguration<Producto>
    {
        ...
        public void Configure(EntityTypeBuilder<Producto> builder)
        {
            ...
            {
                new() {Nombre = "Pipeta gatos", CantidadStock = 0, Categoria = "Farmacia", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849714591042109510/unknown.png", Precio = 2549, ProductoId = 1, TiendaId = 1, Rating = 7,
                Descripcion = @"
                ...
                new() {Nombre = "Dow Chow 20 kg - Carne", CantidadStock = 1, Categoria = "Alimento", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849734389634039848/unknown.png", Precio = 6931, ProductoId = 2, TiendaId = 1, Rating = 5,
                Descripcion = @"
                ...
                new() {Nombre = "Cat Chow 20 kg - Pescado", CantidadStock = 77, Categoria = "Alimento", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849734518260105246/unknown.png", Precio = 2350, ProductoId = 3, TiendaId = 1, Rating = 10,
                Descripcion = @"
                ...
                new() {Nombre = "Collar Anti Pulgas Y Garrapatas Ultrasónico Perros Y Gatos", CantidadStock = 12, Categoria = "Accesorios", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849735109976522809/unknown.png", Precio = 350, ProductoId = 4, TiendaId = 1, Rating = 1,
                Descripcion = @"
                    Advantage® G es una solución antiparasitaria para uso externo, para el tratamiento y prevención de infestaciones por pulgas en gatos de hasta 4 Kg de peso.
                    Beneficios
                    Mata las pulgas dentro de las 24 horas
                ...
                new() {Nombre = "Rascador Para Gato Torre Felpa + Sisal", CantidadStock = 32, Categoria = "Accesorios", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849735366385598474/unknown.png", Precio = 23500, ProductoId = 5, TiendaId = 1, Rating = 0,
                Descripcion = @"
                ...
                new() {Nombre = "Cama circular para Gato - Marron oscuro", CantidadStock = 12, Categoria = "Accesorios", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849843675315175475/unknown.png", Precio = 23500, ProductoId = 6, TiendaId = 1, Rating = 8,
                Descripcion = @"
                ...
                new() {Nombre = "Juguete Gato Cañita Varita Cascabel Raton Plumas Extensible", CantidadStock = 12, Categoria = "Accesorios", Imagen = "https://cdn.discordapp.com/attachments/790717330447138847/849735929639206912/unknown.png", Precio = 197, ProductoId = 7, TiendaId = 1, Rating = 9,
                Descripcion = @"
                    CAÑITA PARA GATO
